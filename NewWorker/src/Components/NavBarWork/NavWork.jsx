...
function NavWork(){
    return(
        ...
        <nav className={`container-fluid ${Style.navbaro} navbar-dark navbar navbar-expand-lg bg-main`}>
          <div className="container">
            <Link className="navbar-brand" to="/"><img src="nocurve.png" className={`${Style.imgo}`}/></Link>
    ...
    <div className={`collapse  ${Style.navbarBrand}  navbar-collapse`} id="navbarSupportedContent">
      <ul className="navbar-nav ms-auto mb-2 mb-lg-0">
        ...
        <li className="nav-item">
          <Link className="nav-link active " to="/addAvailability">Availability</Link>
        </li>
        <li className="nav-item">
        ...
        <li className="nav-item ">
          <Link className="nav-link active" to="/serviceReg">Service</Link>
        </li>
      </ul>
