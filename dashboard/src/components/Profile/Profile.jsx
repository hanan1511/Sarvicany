...
export default function Profile(){
    ...
    async function getProfile(){
        const response = await axios.get(`https://localhost:7188/api/ServiceProvider/ShowProviderProfile?providerId=${workerId}`);
        ...
        const respons1= await axios.get(`https://localhost:7188/api/ServiceProvider/GetServiceProviderAvailability/${workerId}`);
