...
function WorkerReg(){
  ...
  async function registerForm(values) {
    ...
    if (!response.isError) {
      setIsLoading(false);
      navigate("/serviceReg" ,{state: { workerIdProp:decodedToken}});
        ...
        <div className="container py-5">
          ...
          <div className="row">
            <div className="col-md-6">
              <img src="logo.png" className={`${Style.imgo} img-fluid  h-90 `}/>
            </div>
            {error == null ? (
              ""
              ) : (
            ...
            <div className="col-md-6 p-4">
              <div className={`  ${Style.signUpForm}  p-4 rounded-3`}>
                ...
                <h2 className="fw-bold py-5 text-center">Sign Up</h2>
