...
import Style from "./WorkerRegister.module.css";
...
function WorkerRegister() {
  ...
  async function registerForm(values) {
    ...
    const response = await axios
      .post(
        `https://localhost:7188/api/Worker/register?role=ServiceProvider`,
        values
      )
      .catch((err) => {
        setIsLoading(false);
    ...
    if (!response.isError) {
      setIsLoading(false);
      navigate("/servreg", { state: { workerIdProp: decodedToken } });
    }
  }
        ...
        <div className="row">
          ...
          <div className="col-md-6 p-4">
            <div className={`  ${Style.signUpForm}  p-4 rounded-3`}>
              <h2 className="fw-bold py-5">Sign Up</h2>
